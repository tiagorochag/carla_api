...
class World(object):
    ...
    def start(self, hud, input_control):
        ...
        # self.border_round_surface.fill(COLOR_ORANGE_0)
    ...
    def _spawn_hero(self):
        ...
        while self.hero_actor is None:
            ...
            self.hero_actor = self.world.get_actors().filter('vehicle.*')[0]
            # self.hero_actor = self.world.try_spawn_actor(blueprint, initial)
        self.hero_transform = self.hero_actor.get_transform()
...
def game_loop(args):
    ...
    try:
        ...
        start_pose = spawn_points[27]
        destination = spawn_points[40]
